  ...
  return (
    <>
      ...
      <div className="grid gap-2 p-3 md:w-[400px] lg:w-screen lg:grid-cols-[.75fr_1fr]">
        ...
        <div className="space-y-4 mt-4 text-lg font-medium">
          <DisplayCard title="Total Sales" content={FormatToIDR(revenueData)} description={year} />
          <DisplayCard title="Total Order" content={`${allOrderData}`} description={year} />
        </div>
      </div>
    </>
  );
