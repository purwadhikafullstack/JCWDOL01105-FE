...
const PropertyEditor: React.FC = () => {
  ...
  const displayCard = () => {
    if (data && isFetched) return data.map((room: any, index: number) => <RoomCard key={index} rooms={room} />);
    else {
      refetch();
    }
  };
    ...
    <ProtectedRouteTenant>
      <div>
        ...
        <Tabs defaultValue="propertyEditor" className="w-[900px]  ">
          <TabsList>
            <TabsTrigger value="propertyEditor" className="w-[300px] p-2 ">
              Property Editor
            </TabsTrigger>
            <TabsTrigger value="room" className="w-[300px] p-2 ">
              Ruangan
            </TabsTrigger>
            <TabsTrigger value="specialPrice" className="w-[300px] p-2 ">
              Pengaturan Harga
            </TabsTrigger>
          </TabsList>
