...
const TenantSignIn=()=>{
  ...
  <TabsList className="flex">
    <TabsTrigger value="register" className="w-[250px]">Register</TabsTrigger>
    <TabsTrigger value="login" className="w-[250px]">Login</TabsTrigger>
  </TabsList>
  <TabsContent value="register"><RegisterTenant/></TabsContent>
  <TabsContent value="login"><LoginTenant/></TabsContent>
</Tabs>
</div>
    )
}
